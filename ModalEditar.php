<!--ventana para Update--->
<div class="modal fade" id="editChildresn<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form method="POST" action="sets/recib_Update.php">
        ...
        <div class="modal-body" id="cont_modal">
          ...
          <div class="form-group">
            <label for="recipient-name input-group-text" class="col-form-label">Actualizar riesgo:</label>
            <div class="input-group mb-2">
              <span class="input-group-text" id="basic-addon3">Riesgo:</span>
              <select class="form-select"  name="Riesgo" required>
                <option selected value="<?php echo $data['Riesgo']; ?>"><?php echo $data['Riesgo']; ?></option>
