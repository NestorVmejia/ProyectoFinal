...
<body>
  ...
  <div class="container-fluid">
    <div class="col-xl-12">
      ...
      <br>
      <table id="myTable" class="table-sm table-responsive table table-striped table-bordered " style="font-size:medium;">
        ...
        <tbody>
          ...
          while ($data = mysqli_fetch_array($query)) { ?>
            <tr>
              ...
              <td>
                <button type="button"  class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteChildresn<?php echo $data['id']; ?>">
                  <i class="fa-solid fa-circle-minus"></i> Eliminar
                </button>
                <button type="button" class="btn btn-primary btn-sm text-sm" data-toggle="modal" data-target="#editChildresn<?php echo $data['id']; ?>">
                  <i class="fa-solid fa-user-pen"></i> Actualizar
                </button>
                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#citaChildresn<?php echo $data['id']; ?>">
