                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_array($query)) { ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-danger " data-toggle="modal" data-target="#eliminarASdatos<?php echo $data['id']; ?>">
                                    <i class="fa-solid fa-circle-minus"></i>Eliminar
                                </button>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editRegistro<?php echo $data['id']; ?>">
                                    <i class="fa-solid fa-user-pen"></i>Actualizar
                                </button>
                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#citaChildresn<?php echo $data['id']; ?>">
                                    <i class="fa-solid fa-check-to-slot"></i>Asistencia
                                </button>
                            </td>
                        </tr>
                        <!--Ventana Modal para Actualizar--->
                        <?php include('ModalAsistEditar.php'); ?>
                        <!--Ventana Modal para la Alerta de Eliminar--->
                        <?php include('ModalAsistEliminar.php'); ?>
                        <!--Ventana Modal para CITA--->
                        <?php include('ModalCitaAsist.php'); ?>
                    <?php } ?>
            </table>
        </div>
    </div>
