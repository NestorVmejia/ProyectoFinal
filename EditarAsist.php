...
<body>
	...
	<div class="height-100" style=" position:sticky">
		...
		<?php
		if ($_POST['nss'] == "") { ?>
			<form name="forma1" id="forma1" class="form-horizontal" role="form" method="post" action="EditarAsist.php">
			...
			<div class="row justify-content-center">
				<div class="col-md-5">
					<div class="card border">
						...
						<br>
						<center>
							<form name="forma2" id="forma2" class="form-horizontal" role="form" method="post" action="sets/registroAs.php">
								<?php
                ...
                window.location.href="Editar.php";
						...
						<div class="card-body">
							<form name="forma3" id="forma3" class="form-horizontal" role="form" method="POST" action="sets/registroAs.php">
